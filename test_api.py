...
class TestMovieView(TestCase):
    def setUp(self):
        ...
        self.user_login_data = {"username": "user", "password": "1234abcd$"}
        ...
        self.critic_login_data = {
            "username": "critic", "password": "1234abcd$"}
        ...
        self.admin_login_data = {"username": "admin", "password": "1234abcd$"}
...
class TestMovieRetrieveDestroyView(TestCase):
    ...
    def test_critic_cannot_delete_movies(self):
        ...
        status_code = self.client.delete(
            "/api/movies/1/", format="json").status_code
        self.assertEqual(status_code, 403)
...
class TestAccountView(TestCase):
    ...
    def test_create_and_login_for_critic_account(self):
        ...
        # create user
        user = client.post(
            "/api/accounts/", self.critic_data, format="json").json()
